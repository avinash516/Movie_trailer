...
a number of movies. Click on a movie poster to play its trailer in youtube link.
...
Python3 is required to run this project. The Python executable should be in
